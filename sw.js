const CACHE='osaka-happy-v4.1-20260911';
const CORE=['./','./index.html','./styles.css','./app.js','./data.json','./manifest.webmanifest','./icon-192.png','./icon-512.png','./images/osaka.svg','./images/food.svg','./images/kuromon.svg','./images/kyoto.svg','./images/kamikochi.svg','./images/shirakawa.svg'];
